#Questão 3: Faça um programa que leia 10 números inteiros e armazene-os em um vetor. 
#Em seguida escreva os elementos desse vetor que não são primos e suas respectivas 
#posições no vetor.
.data
